...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert("stock", [
      {
        id_product: 1, // ID du produit ASUS DUAL GeForce RTX 3050
        quantity: 50, // Quantité initiale de stock
      },
      {
        id_product: 2, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 30, // Quantité initiale de stock
      },
      {
        id_product: 3, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 20, // Quantité initiale de stock
      },
      {
        id_product: 4, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 20, // Quantité initiale de stock
      },
      {
        id_product: 5, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 60, // Quantité initiale de stock
      },
      {
        id_product: 6, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 30, // Quantité initiale de stock
      },
      {
        id_product: 7, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 25, // Quantité initiale de stock
      },
      {
        id_product: 8, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 18, // Quantité initiale de stock
      },
      {
        id_product: 9, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 13, // Quantité initiale de stock
      },
      {
        id_product: 10, // ID du produit ASUS Dual GeForce RTX 4060
        quantity: 7, // Quantité initiale de stock
      },
      // ... autres stocks pour les autres produits
    ]);

    // Réinitialise l'auto-incrémentation de l'ID du stock pour éviter les conflits
    await queryInterface.sequelize.query(
