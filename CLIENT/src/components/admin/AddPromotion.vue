<template>
    <div class="p-6 bg-gray-100 min-h-screen">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Ajouter une Promotion</h1>
        </div>
        <form @submit.prevent="createPromotion" class="bg-white p-8 rounded-lg shadow-md space-y-6">
...
const createPromotion = async () => {
    ...
    try {
        await ApiClient.post('/promotions', promotion.value);
